...
We aim on people who wondering to communicate with other as the topic as computer tech and network skill. We also encourage teenage to play with code, mathematics, and hardwares when they find our game.

### Success Criteria

An event, a party that brings everyone together to play. To assess the success of this game, one should look beyond just profit and user numbers. We envision our game as a tool that enables quick socializing for players, even in unfamiliar public spaces. Here's an instance: in the current Chinese context of team-building work events and business negotiations, Honor of Kings – a mobile game akin to Dota – has taken over as the primary social instrument, surpassing traditional dinner gatherings or golf. In my view, if our game becomes one of the activity options at parties, then that will mark our success.

Success Criteria:
The true measure of our app's success isn't solely financial gain or the sheer number of users. It's about user satisfaction, market share, and the public good. We will evaluate our game's triumph through its ability to facilitate quick social interactions in any setting, its adoption as a preferred social tool in various gatherings, and if it becomes a go-to choice for entertainment at parties. These indicators will tell us that our game has achieved its goal, beyond just the bottom line.
...
User Account (Username and Password) will be store online, e.g. AWS.
User Generate-Content (Skill, Purchases, and Level) will be store online.

### GPS sensors

Unity may not invoke iOS Devices' GPS sensor, so that is the reason we may use Xcode and Unity together.

### Interaction With AWS

We have few experiences with AWS, so we may meet many issues with we deploy a response server on AWS.
